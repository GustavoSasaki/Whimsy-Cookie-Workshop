...
export function IntroductionImgs() {
    ...
    const bakingY = useTransform(
        translateY, [0.2, 0.8], ["-12%", "12%"]
    )

    const cookieY = useTransform(
        translateY, [0.2, 0.8], ["10%", "-10%"]
    )
    return (
        <div className="w-[44vw] max-w-[400px] box-border relative ml-8">
            ...
            >
                <motion.img ref={imageRef} className="relative top-[-13%] h-[128%] w-full rounded-lg"
                    style={{
                        y: bakingY,
                    }}
                    alt="baking cookies"
            ...
            <div className="absolute w-6/12  aspect-[6/9] top-0 bottom-0 my-auto right-0 z-20 overflow-hidden rounded-lg">
                <motion.img src={cookieImg} className='rounded-lg top-[-11%] h-[124%] w-full relative'
                    alt="cookies"
                    style={{
                        y: cookieY,
                    }}
...
const cookieImg = 'https://ngchltiyfhxkbpitthto.supabase.co/storage/v1/object/public/cookies-sanca/arvid-skywalker-aGhS-JQMB_g-unsplash.jpg'
const bakingImg = "https://ngchltiyfhxkbpitthto.supabase.co/storage/v1/object/public/cookies-sanca/image.jpg"