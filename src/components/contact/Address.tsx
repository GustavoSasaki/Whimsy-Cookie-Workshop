...
import {
    AiOutlinePhone, AiOutlineWhatsApp, AiOutlineClockCircle, AiOutlineEnvironment,
...
export default function Address() {
    ...
    const y = useTransform(
        translateY, [0,0.6, 1], ["0%","0%", "20%"]
    )


    return (
        <motion.div className="text-xl p-3 font-medium text-shadow-sm" ref={addressRef}
            style={{
                y
            }}
        >
            ...
            <div className="flex mb-3">
                ...
                <p>seg-sab das <time dateTime="09:00:00">9</time>-<time dateTime="18:00:00">18h</time></p>

            </div>
            <div className="flex mb-3">
                <AiOutlineEnvironment className="w-[30px] h-[30px] mr-2 text-contact-icon" />
                <p>R. Major José Inácio, 2154<br /> São Carlos, Brazil</p>
            </div>
