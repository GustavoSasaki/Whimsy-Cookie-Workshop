    ...
    return (
        <header>
            <nav className="flex w-full justify-between items-center font-bold text-xl">
                ...
                <button onClick={(event) => scrollToPosition(aboutRef)} className="hover:text-white">
                    about
                </button>
                <a href=".">
                    <img
                ...
                <button onClick={() => scrollToPosition(contactRef)} className="hover:text-white">
                    contact
                </button>
            </nav>
        </header>
...
const logoImg = "https://ngchltiyfhxkbpitthto.supabase.co/storage/v1/object/public/cookies-sanca/logo2"
